...
try {
  ...
  python -m nuitka `
    ...
    --include-module=nghia_enhanced_engine `
    --include-module=nghia_enhanced_sensor `
  ...
  if ($LASTEXITCODE -ne 0) { throw 'Nuitka demo build failed' }
...
Write-Host 'V1005_DEMO_NUITKA_PE_OK'
