    ...
    json.dumps(
        {
            ...
            "notes": "Nghia V10.0.16 Custom SAFE ENTRY + FARM RETURN",
            "state": "up_to_date",
        },
        indent=2,
        ensure_ascii=False,
...
if missing_required:
    raise SystemExit(
        "V10.0.16 updater payload missing launcher-required files: " + ", ".join(missing_required)
    )
...
report = {
    "version": VERSION,
    "variant": "CustomSafeEntryReturn",
    "base_release": "v10.0.15",
    "custom_map_only": True,
    "safe_entry_optional": True,
    "farm_return_optional": True,
    "safe_entry_up_jump": True,
    "farm_return_down_jump": True,
    "post_sell_return_to_farm": True,
    "upper_floor_fall_recovery_route": True,
    "legacy_custom_profile_fallback": True,
    "v1015_human_rest_preserved": True,
    "v1014_sell_trigger_arbitration_preserved": True,
    "shared_sell_safe_stage_unchanged": True,
    "original_maps_preserved": True,
